...
| **Run tags auto graph pipeline** | [Tags Auto Graph Workflow](user-guide/tags-graph-auto.md) |
...
4. **[Tags Auto Graph Workflow](user-guide/tags-graph-auto.md)** (15-20 min)
   - `sync_run` for tags/tag_edges refresh
   - `optimize_run` for log-driven edge tuning
   - Safe daily routine with dry-run first
